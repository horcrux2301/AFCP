...
export default {
  ...
  activate(state) {
    ...
    /*directories*/
    this.Codechefdir = atom.config.get('Codeforces-Automation.Codechef');
    this.Codeforcesdir = atom.config.get('Codeforces-Automation.Codeforces');
    this.Atcoderdir = atom.config.get('Codeforces-Automation.Atcoder');
    this.TimeLimit = atom.config.get('Codeforces-Automation.TimeLimit');
    atom.config.observe('Codeforces-Automation.Codechef', (newValue) => {
      this.Codechefdir = newValue;
    });
    atom.config.observe('Codeforces-Automation.Codeforces', (newValue) => {
      this.Codeforcesdir = newValue;
    });
    atom.config.observe('Codeforces-Automation.Atcoder', (newValue) => {
      this.Atcoderdir = newValue;
    });
    atom.config.observe('Codeforces-Automation.TimeLimit', (newValue) => {
