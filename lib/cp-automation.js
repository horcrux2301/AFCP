      ...
      if (this.platform === 'darwin' || this.platform === "linux") {
        ...
        const executeFilePromise = new Promise((resolve, reject) => {
          ...
          const childProcess = exec(command, {
            ...
            if (err) {
              ...
              //        console.log("id to kill is ", childProcess.pid);
              // pidtree(childProcess.pid, function (err, pids) {
              //   console.log(pids)
              //   // => []
              // })
        ...
        if (child.pid) {
          ...
          try {
            ...
            f2 = 1;
            // console.log(err);
            atom.notifications.addInfo(`No output${a}.txt found in this directory. Time taken: ${time} seconds`, {
              dismissable: true
            });
          }
          let f3 = 0;
